...
public class ListBalanceFriendsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_balance_friends);
        ...
        final Call<List<Balance>> balance = api.getBalancesFriends("5b9fca1fcc0abb069ba66f3d");

        balance.enqueue(new Callback<List<Balance>>() {
            @Override
            public void onResponse(Call<List<Balance>> call, Response<List<Balance>> response) {
                ListBalancesAdapter adapter = new ListBalancesAdapter(ListBalanceFriendsActivity.this,R.layout.list_balances,response.body());
                listViewBalances.setAdapter(adapter);
            }
            @Override
            public void onFailure(Call<List<Balance>> call, Throwable t) {
                Toast.makeText(ListBalanceFriendsActivity.this, "Connection refuse", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    void weekBalances() {
        Intent intent = new Intent(ListBalanceFriendsActivity.this, ListBalanceFriendsWeekActivity.class);
    ...
    void backToProfile() {
        Intent intent = new Intent(ListBalanceFriendsActivity.this, ProfileActivity.class);
        startActivity(intent);
        finish();
    }
}
